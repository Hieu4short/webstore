...
;        } catch (error) {
    ...
    return <div className="container xl:mx-[9rem] sm:xm-[0]">
                ...
                <div className="P-3">
                    ...
                    <div className="flex justify-betwwen">
                        <div>
                            ...
                            text-white" value={stock} onChange={e => setStock(e.target.value)}>
                            </input>
                        </div>
                        <div>
                            <label htmlFor="">Category</label> <br/>
                            <select placeholder="Choose category" className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] 
                            text-white" onChange={e => setCategory(e.target.value)}>{categories?.map((c) => (
