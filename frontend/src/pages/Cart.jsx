...
const Cart = () => {
    ...
    return <>
            <div className="container flex justify-around items-start flex wrap mx-auto mt-8">
                {cartItems.length === 0 ? (<div>Your cart is empty, <Link to="/shop">Go back to shop</Link></div>) : (
                    <>
                        <div className="flex flex-col w-[80%]">
                            <h1 className="text-2xl font-semibold mb-4">Shopping Cart </h1>

                            {cartItems.map((item) => (
                                <div className="flex items-center mb-[1rem] pb-2" key={item._id}>
                                    ...
                                    <div>
                                        <button
                                        className="text-red-500 mr-[5rem]" onClick={() => removeFromCartHandler(item._id)}>
                            ...
                            <div className="mt-8 w-[40rem]">
                                ...
                                <h2 className="text-xl font-semibold mb-2">Items ({cartItems.reduce((acc, item) => acc + item.qty, 0)})</h2>
                                    ...
                                    <div className="text-2xl font-bold">${" "} {cartItems
