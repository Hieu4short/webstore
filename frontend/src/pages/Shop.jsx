...
const Shop = () => {
    ...
    useEffect(() => {
        if (!checked.length || !radio.length) {
            if(!filteredProductsQuery.isLoading) {
                //Filter products based on both checked categories and prices filter
    ...
    const handleBrandClick = (brand) => {
      ...
      // Add "All brand" option to the unique brand
      const uniqueBrands = [
        ...Array.from(
          new Set(
            ...
            <div className="container mx-auto">
                <div className="flex md:flex-row">
                    <div className="bg-[#151515] p-3 mt-2 mb-2">
                        ...
                        <div className="p-5 w-[15rem]">{categories?.map((c) => (
                        ...
                        {uniqueBrands?.map((brand) => (
                            <div key={brand} className="flex items-enter mr-4 mb-5">
                                ...
                                className="ml-2 text-sm font-medium text-white dark:text-gray-300">{brand}
                                </label>
                            </div>
                            ))}
                        </div>
